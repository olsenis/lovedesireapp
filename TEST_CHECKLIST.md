...
- [ ] **Clear for both needs the partner** 📱
  ...
  - **Expected:** A's row showed "Waiting for Eva to agree. Your own part you can clear right now." with Cancel. After B agrees everything is gone for both, Storage prefix empty, request and Home card gone. **The asker reads the answer:** after "Agree and clear" A's row says "Eva agreed. It is cleared for both of you…" with OK, and A's Home has a card "Eva agreed to clear Moments"; after "Not now" the row says "Eva said not now, so nothing was cleared. Your own part is still yours to clear." and nothing is deleted. OK removes the row text and the Home card on A's phone. B never sees a card about B's own answer. Dev build: the push to A reads "Eva answered you" for both answers.
