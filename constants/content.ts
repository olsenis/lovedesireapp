...
export const DARES: Dare[] = [
  ...
  { text: "Slow dance with them for the full duration of the next song, holding them tight.", level: 'flirty' },
  ...
  // Spicy — physical actions only
  { text: "Give a 15-minute full body massage.", level: 'spicy' },
  { text: "Slowly remove their top — take at least 2 full minutes.", level: 'spicy' },
  { text: "Run an ice cube slowly along their arm, neck, or collarbone.", level: 'spicy' },
  ...
  { text: "Tie their hands loosely behind their back and spend 3 minutes on their neck.", level: 'spicy' },
  ...
  { text: "Spend 3 full minutes kissing their stomach — no higher, no lower.", level: 'spicy' },
  { text: "Lie them down and give a slow scalp massage for 5 full minutes.", level: 'spicy' },
  ...
  { text: "Start at their neck and kiss your way slowly down — stop wherever they ask.", level: 'spicy' },
  ...
  { text: "Give a slow hip and lower back massage — don't stop for 5 full minutes.", level: 'spicy' },
  ...
  { text: "Use your lips and tongue to explore their shoulders and collarbones for 3 full minutes.", level: 'spicy' },
