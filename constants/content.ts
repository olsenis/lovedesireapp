...
export const DARES: Dare[] = [
  ...
  // ── Spicy ── explicitly sexual, X-rated ────────────────────────────────────
  { text: "Slowly undress them completely — take at least 3 full minutes, no rushing.", level: 'spicy' },
  { text: "Do a slow striptease for them — take at least 3 full minutes.", level: 'spicy' },
  { text: "Run an ice cube slowly down their bare body from neck to stomach.", level: 'spicy' },
  { text: "Spend 5 full minutes kissing them everywhere except their lips.", level: 'spicy' },
  { text: "Tie their hands loosely and use your mouth on their neck, chest, and stomach.", level: 'spicy' },
  { text: "Use only your mouth on their inner thighs for 3 full minutes.", level: 'spicy' },
  { text: "Take one intimate photo of yourself and send it to them right now.", level: 'spicy' },
  { text: "Use only your lips and hands to explore their chest and stomach for 5 minutes.", level: 'spicy' },
  { text: "Spend 3 full minutes kissing their stomach — don't go higher or lower.", level: 'spicy' },
  { text: "Blindfold them and use your hands and mouth to explore their full body.", level: 'spicy' },
  { text: "Give them oral — set a 5-minute timer and don't stop before it ends.", level: 'spicy' },
  { text: "Give a full body massage — no area is off limits, only stop when they beg you to.", level: 'spicy' },
  { text: "Trace every curve of their body from shoulder to hip — slowly, eyes closed.", level: 'spicy' },
  { text: "Take turns being in control — set a timer for 5 minutes each.", level: 'spicy' },
  { text: "Start at their neck and kiss your way slowly all the way down their body.", level: 'spicy' },
  { text: "Use something cold and something warm alternately on their bare skin.", level: 'spicy' },
  { text: "Ask them to guide your hands — you must go exactly where they direct.", level: 'spicy' },
  { text: "Take their wrists gently and pin them — hold for 30 seconds, then let go slowly.", level: 'spicy' },
  { text: "Kiss them deeply, then pull back and tease — three times before going all in.", level: 'spicy' },
  { text: "Give a massage from their feet all the way up — don't stop at the hips.", level: 'spicy' },
  { text: "Let them undress you — you cannot help, rush, or touch them back.", level: 'spicy' },
  { text: "Use your lips and tongue to explore their stomach and hips — take your time.", level: 'spicy' },
  { text: "Blindfold them, then use a feather and an ice cube — alternate slowly.", level: 'spicy' },
  { text: "Act out a role-play scenario — pick any two roles and commit for 10 minutes.", level: 'spicy' },
  { text: "Kiss the full length of their spine slowly — then come back up the same way.", level: 'spicy' },
  { text: "Spend 10 minutes using only your hands — no lips allowed until the timer ends.", level: 'spicy' },
  { text: "Lie them face down and use your lips from their ankles all the way up to their neck.", level: 'spicy' },
  { text: "Take their hand and show them exactly how you want to be touched.", level: 'spicy' },
  { text: "Take off their top using only your teeth — take as long as you need.", level: 'spicy' },
];
