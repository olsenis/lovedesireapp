...
export const DARES: Dare[] = [
  ...
  // ── Spicy ── X-rated, explicit language ───────────────────────────────────
  ...
  { text: "Run an ice cube down their naked body — neck, chest, stomach. Watch them react.", level: 'spicy' },
  { text: "Kiss every inch of their body for 5 minutes — everywhere except their lips.", level: 'spicy' },
  { text: "Tie their wrists loosely and use your mouth on their neck, nipples, and stomach.", level: 'spicy' },
  { text: "Lick and kiss their inner thighs for 3 full minutes — don't go further until they beg.", level: 'spicy' },
  { text: "Take a naked or semi-naked photo of yourself and send it to them right now.", level: 'spicy' },
  { text: "Use your hands and mouth on their chest and nipples for 5 minutes — nothing else.", level: 'spicy' },
  { text: "Kiss and lick their stomach for 3 minutes — stop exactly at the waistband.", level: 'spicy' },
  { text: "Blindfold them. Use your hands, mouth, and tongue on every part of their body.", level: 'spicy' },
  { text: "Go down on them — 5-minute timer, no stopping, no skipping.", level: 'spicy' },
  { text: "Give a full naked body massage — every part. Only stop when they tell you to.", level: 'spicy' },
  { text: "Run your hands slowly from their shoulders down to their ass — eyes closed, take your time.", level: 'spicy' },
  { text: "Take turns dominating — 5 minutes each. The one in control decides everything.", level: 'spicy' },
  { text: "Kiss their neck, then work your way down their entire body — all the way.", level: 'spicy' },
  { text: "Use ice and warm hands alternately on their naked skin — watch their body respond.", level: 'spicy' },
  { text: "Let them take your hands and place them wherever they want — do exactly what they show you.", level: 'spicy' },
  { text: "Pin their wrists above their head. Hold them there and kiss them hard — then let go slowly.", level: 'spicy' },
  { text: "Get them close with your hands or mouth — then pull back. Do it three times before finishing.", level: 'spicy' },
  { text: "Massage them from feet to ass — slow hands, no skipping, no rushing.", level: 'spicy' },
  { text: "Let them strip you completely — you cannot touch them or help. Just let it happen.", level: 'spicy' },
  { text: "Use your tongue from their stomach down to their hips — slow and deliberate.", level: 'spicy' },
  { text: "Blindfold them. Run a feather and then an ice cube over their naked body — take turns.", level: 'spicy' },
  { text: "Pick a role-play scenario and commit fully for 10 minutes — no breaking character.", level: 'spicy' },
  { text: "Lick slowly up their entire spine — then kiss your way back down.", level: 'spicy' },
  { text: "Use only your hands on them for 10 minutes — no mouth allowed until the timer goes off.", level: 'spicy' },
  { text: "Lie them face down. Kiss and lick from their ankles all the way up to their neck — slowly.", level: 'spicy' },
  { text: "Take their hand and guide it to show them exactly where and how you want to be touched.", level: 'spicy' },
  { text: "Take off their underwear using only your teeth.", level: 'spicy' },
];
