...
export const DARES: Dare[] = [
  // Sweet — romantic, cute, immediate physical actions
  ...
  { text: "Give a slow 10-minute back scratch — don't stop until they ask you to.", level: 'sweet' },
  { text: "Give a 5-minute scalp massage right now.", level: 'sweet' },
  ...
  { text: "Give them a 3-minute face and temple massage — use your fingertips.", level: 'sweet' },
  ...
  { text: "Give their feet a warm 5-minute rub — slow and careful.", level: 'sweet' },
  { text: "Draw them a quick portrait — take at least 5 minutes.", level: 'sweet' },
  { text: "Give them a 5-minute hand and wrist massage — slow and deliberate.", level: 'sweet' },
  // Flirty — sensual, kissing, physical teasing
  ...
  { text: "Give a slow dance to whatever song comes on next — hold them close.", level: 'flirty' },
  { text: "Give a long, slow back massage — no rushing.", level: 'flirty' },
  { text: "Give them a surprise kiss right now.", level: 'flirty' },
  { text: "Take their face in both hands and kiss them like you mean it.", level: 'flirty' },
  { text: "Recreate your first kiss.", level: 'flirty' },
  { text: "Gently bite their bottom lip during your next kiss.", level: 'flirty' },
  { text: "Maintain eye contact for 10 seconds — no breaking, no smiling.", level: 'flirty' },
  ...
  { text: "Run your fingers slowly through their hair — take your time.", level: 'flirty' },
  ...
  { text: "Make deliberate eye contact from across the room and hold it without looking away.", level: 'flirty' },
  { text: "Pull them close and hold them against you without saying a word for a full minute.", level: 'flirty' },
  { text: "Kiss their hand slowly, like you mean it.", level: 'flirty' },
  ...
  { text: "Put your hands on their hips and pull them toward you.", level: 'flirty' },
  { text: "Kiss their collarbone slowly, then work your way up to their jaw.", level: 'flirty' },
  { text: "Text them something flirty you've been thinking about but hadn't said.", level: 'flirty' },
  ...
  { text: "Give a full body massage — no area is off limits.", level: 'spicy' },
  { text: "Slowly undress them completely — take at least 3 full minutes, no rushing.", level: 'spicy' },
  { text: "Run an ice cube slowly down their body from neck to stomach.", level: 'spicy' },
  { text: "Do a slow striptease for them — take at least 3 minutes.", level: 'spicy' },
  ...
  { text: "Give a full body massage — only stop when they beg you to.", level: 'spicy' },
  ...
  { text: "Give a massage starting at their feet and work all the way up — don't stop at the hips.", level: 'spicy' },
  { text: "Give a slow hip and lower back massage — 5 full minutes, no shortcuts.", level: 'spicy' },
  ...
  { text: "Give a sensory experience — blindfold them, then use a feather and an ice cube.", level: 'spicy' },
