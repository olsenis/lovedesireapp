...
**From USER_VOICE.md (review mining, Sep 13 2026), post-launch order:** 9. react or one-line reply on a revealed answer (Daily, Sunday, Memory Lane; 259 "wish I could discuss" mentions, no chat tab) · 10. past-answers archive by week (Agapé's scrapbook) · 11. custom mood label (Cozy Couples' most repeated wish) · 12. lifetime SKU test (Between, Nice, SumOne praise it) · 13. solo first week on Home before the partner joins · 14. per-partner body configuration for explicit content (koopla) and an LDR question category toggle · 15. Google Play listing if sideload numbers say Android users bounce · 16. reply to every review for 90 days. The pre-launch items (P0 to P7: new partner never inherits old data, lapsed subscription keeps read access, billing honesty, discreet pushes, Daily no-repeat, Fantasy Wishes opt-out, app lock, store copy) are in USER_VOICE §7 and BUG_BASH.
