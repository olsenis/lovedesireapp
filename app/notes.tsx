...
const OCCASIONS = [
  ...
  { label: "Tonight at 8pm", offset: -1 }, // calculated below
  { label: "Tomorrow morning", offset: -1 },
  { label: "This weekend", offset: -1 },
  { label: "In 1 week", offset: 7 * 24 * 60 * 60 * 1000 },
  { label: "When you're sad", offset: 0 }, // opens immediately but labelled
];
    ...
    <View style={styles.screen}>
          ...
          <>
            ...
            {forMe.map((note) => {
              ...
              return (
                <TouchableOpacity
                  key={note.id}
                  style={[styles.noteCard, canOpen ? styles.noteReady : styles.noteLocked]}
      ...
      {openedNote && (
        <Modal visible transparent animationType="fade">
          <TouchableOpacity style={styles.noteViewer} onPress={() => setOpenedNote(null)}>
...
const styles = StyleSheet.create({
  ...
  mySent: { backgroundColor: Colors.white, opacity: 0.85 },
  noteLockEmoji: { fontSize: 28 },
  noteInfo: { flex: 1 },
  ...
  occasionBtn: { paddingVertical: Spacing.xs, paddingHorizontal: Spacing.md, borderRadius: Radius.full, backgroundColor: Colors.white, borderWidth: 1, borderColor: Colors.border },
  ...
  noteViewer: { flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', alignItems: 'center', justifyContent: 'center', padding: Spacing.xl },
  ...
  noteViewerEmoji: { fontSize: 56 },
  noteViewerMsg: { fontFamily: Fonts.heading, fontSize: 22, color: Colors.text, textAlign: 'center', lineHeight: 32 },
