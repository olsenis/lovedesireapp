...
const GAMES = [
  { emoji: '💬', title: 'Questions Game',       subtitle: 'Playful, Deep and Spicy · answer privately, reveal together', route: '/questions-game', bg: '#E3F2FD', paid: false },
  { emoji: '🆚', title: 'Versus',               subtitle: 'How well do you know your partner? Guess their answers', route: '/versus',         bg: '#FFE5EC', paid: false },
