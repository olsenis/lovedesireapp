...
const GAMES = [
  ...
  { emoji: '✨', title: 'Fantasy Match',        subtitle: 'Double-blind — only mutual Yes is ever revealed', route: '/fantasy',   bg: '#EDE7F6' },
  { emoji: '🌹', title: 'Shared Wishlist',      subtitle: 'Experiences you both want — matched privately', route: '/wishlist',   bg: '#FCE4EC' },
];
