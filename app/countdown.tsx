          ...
          return (
            <View key={d.id} style={[styles.card, isToday && styles.cardToday]}>
              ...
              <View style={styles.cardMiddle}>
                ...
                <Text style={styles.cardDate}>{new Date(d.date).toLocaleDateString('en-GB', { day: 'numeric', month: 'long' })}</Text>
              </View>
              ...
              <TouchableOpacity onPress={() => profile?.coupleId && deleteImportantDate(profile.coupleId, d.id)} style={styles.deleteBtn}>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: Colors.white, borderRadius: Radius.xl, padding: Spacing.md, flexDirection: 'row', alignItems: 'center', gap: Spacing.md, borderWidth: 1, borderColor: Colors.border },
  ...
  cardDate: { fontFamily: Fonts.body, fontSize: 13, color: Colors.muted },
  cardRight: { alignItems: 'center' },
  daysNum: { fontFamily: Fonts.heading, fontSize: 36, color: Colors.burgundy, lineHeight: 40 },
  daysLabel: { fontFamily: Fonts.bodyItalic, fontSize: 12, color: Colors.muted },
  todayBadge: { fontFamily: Fonts.bodyBold, fontSize: 14, color: Colors.burgundy },
